        ...
        <div v-else>
            <div class="flex justify-between items-center mb-4">
                ...
                <div class="flex gap-2">
                    <button class="text-sm px-3 py-1 bg-gray-200 hover:bg-gray-300 rounded"
                        @click="goBack">Back</button>
                    <button class="text-sm px-3 py-1 bg-green-200 hover:bg-gray-300 rounded"
                        @click="goHome">Home</button>
                    <button v-if="canEdit"
            ...
            <div class="mb-4">
                ...
                <span v-for="category in post.categories" :key="category"
                    class="inline-block bg-green-100 text-green-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded">
                    {{ category }}
                </span>
            </div>
        </div>
